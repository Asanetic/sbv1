...
export const SitesSchema = {
  ...
  fields: [
    ...
    { key: 'site_location', type: 'text', searchable: true },
    ...
    { key: 'account_number', type: 'text', searchable: true },
    { key: 'stk_flag', type: 'text', searchable: true },
  ...
  batchMutations: {
    ...resolveJoin('contact_person', { as: 'name' }),
  },
