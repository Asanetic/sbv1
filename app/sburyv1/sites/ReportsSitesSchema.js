...
const moduleApi = apiRoutes.reportssites.base;

export const ReportsSitesSchema = {
  entity: 'site_list',              // DB table name; also drives default role names
  ...
  importDataEndpoint : apiRoutes.reportssites.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/sites/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Site', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/sites/profile', grid: true, form: false, rowAction: false },
  ...
  showInList: ['row_count', 'site_name', 'site_location', 'contact_person', 'contact_person_mobile', 'remark', 'project_id', 'project_name'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['site_name', 'site_location', 'contact_person', 'contact_person_mobile', 'remark', 'project_id', 'project_name'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['site_name', 'site_location', 'contact_person', 'contact_person_mobile', 'remark', 'project_id', 'project_name'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['account_number', 'stk_flag'] },
  ],
  ...
  fields: [
    ...
    { key: 'site_location', label: 'Site Location', type: 'text' },
    ...
    { key: 'stk_flag', label: 'Stk Flag', type: 'text' },
