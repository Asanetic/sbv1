...
// ProjectsSitesProfile — pure shell. It resolves the id, wires up the
...
export default function ProjectsSitesProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || ProjectsSitesSchema;
  const id = idProp ?? searchParams.get(`${ProjectsSitesSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, SitesActions, {
    id,
    onDone,
