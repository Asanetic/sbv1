...
// ReportSitesProfile — pure shell. It resolves the id, wires up the
...
export default function ReportSitesProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || ReportSitesSchema;
  const id = idProp ?? searchParams.get(`${ReportSitesSchema.entity}_dataNode`);
