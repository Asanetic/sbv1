...
const moduleApi = apiRoutes.attendance.base;

export const AttendanceSchema = {
  entity: 'attendance_list',              // DB table name; also drives default role names
                                     // (view_attendance / manage_attendance) and apiBase
  label: 'Attendance',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.attendance.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/attendance/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this attendance?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_attendance' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Attendance', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/attendance/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_attendance' },
  ...
  showInList: ['row_count', 'name', 'mobile', 'national_id', 'daily_wages', 'remark', 'paid_status', 'paid_ref_no'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['name', 'mobile', 'national_id', 'daily_wages', 'remark', 'paid_status', 'paid_ref_no'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['name', 'mobile', 'national_id', 'daily_wages', 'remark', 'paid_status', 'paid_ref_no'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['site_id', 'site_name', 'date_paid', 'roll_date', 'day_count', 'deductions', 'deduction_remark', 'task_assigned', 'project_phase', 'sitetest'] },
  ],
  ...
  fields: [
    ...
    { key: 'daily_wages', label: 'Daily Wages', type: 'text' },
    { key: 'remark', label: 'Remark', type: 'textarea', colSpan: 3 },
    { key: 'paid_status', label: 'Paid Status', type: 'text' },
    { key: 'paid_ref_no', label: 'Paid Ref No', type: 'text' },
    ...resolveField('site_id', { as: 'site_name' }),
    { key: 'site_name', label: 'Site Name', type: 'text', title: true, required: true },
    { key: 'date_paid', label: 'Date Paid', type: 'datetime' },
    { key: 'roll_date', label: 'Roll Date', type: 'datetime' },
    { key: 'day_count', label: 'Day Count', type: 'text', computed: true, sum: true },
    { key: 'deductions', label: 'Deductions', type: 'text' },
    { key: 'deduction_remark', label: 'Deduction Remark', type: 'textarea', colSpan: 3 },
    { key: 'task_assigned', label: 'Task Assigned', type: 'text' },
    { key: 'project_phase', label: 'Project Phase', type: 'text' },
    { key: 'sitetest', label: 'Sitetest', type: 'text' },
