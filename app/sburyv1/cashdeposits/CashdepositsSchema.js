...
const moduleApi = apiRoutes.cashdeposits.base;

export const CashdepositsSchema = {
  entity: 'cash_deposits',              // DB table name; also drives default role names
                                     // (view_cashdeposits / manage_cashdeposits) and apiBase
  label: 'Cashdeposits',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.cashdeposits.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/cashdeposits/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this cashdeposit?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_cashdeposits' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Cashdeposit', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/cashdeposits/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_cashdeposits' },
  ...
  showInList: ['row_count', 'date_posted', 'amount_posted', 'posting_remark', 'project_name'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['amount_posted', 'posted_by', 'date_posted', 'posting_remark', 'admin_name', 'project_id', 'project_name'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['amount_posted', 'posted_by', 'date_posted', 'posting_remark', 'admin_name', 'project_id', 'project_name'] },
  ],
  ...
  fields: [
    ...
    { key: 'postkey', label: 'Postkey', type: 'text', system: true, editable: false },
    { key: 'amount_posted', label: 'Amount Posted', type: 'money' , sum: true},
    ...resolveField('posted_by', { as: 'name' }),
    { key: 'date_posted', label: 'Date Posted', type: 'datetime' },
    { key: 'posting_remark', label: 'Posting Remark', type: 'textarea', colSpan: 3 },
    { key: 'admin_name', label: 'Admin Name', type: 'text', title: true, required: true },
    ...resolveField('project_id', { as: 'site_name' }),
