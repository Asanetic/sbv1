...
const moduleApi = apiRoutes.contractors.base;

export const ContractorsSchema = {
  entity: 'contractors',              // DB table name; also drives default role names
                                     // (view_contractors / manage_contractors) and apiBase
  label: 'Contractors',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.contractors.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/contractors/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this contractor?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_contractors' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Contractor', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/contractors/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_contractors' },
  ...
  showInList: ['row_count', 'name', 'phone_number', 'business_name', 'speciality'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['name', 'phone_number', 'email', 'business_name', 'speciality', 'remark'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['name', 'phone_number', 'email', 'business_name', 'speciality', 'remark'] },
  ],
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_contractors', manage: 'manage_contractors' },
};
