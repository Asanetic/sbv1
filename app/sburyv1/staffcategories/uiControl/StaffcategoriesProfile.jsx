...
// StaffcategoriesProfile — pure shell. It resolves the id, wires up the
...
export default function StaffcategoriesProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || StaffcategoriesSchema;
  const id = idProp ?? searchParams.get(`${StaffcategoriesSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, StaffcategoriesActions, {
    id,
    onDone,
