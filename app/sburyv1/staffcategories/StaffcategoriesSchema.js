...
const moduleApi = apiRoutes.staffcategories.base;

export const StaffcategoriesSchema = {
  entity: 'staff_categories',              // DB table name; also drives default role names
                                     // (view_staffcategories / manage_staffcategories) and apiBase
  label: 'Staffcategories',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.staffcategories.import,
  ...
  moduleRole: 'view_staffcategories',
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/staffcategories/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this staffcategorie?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_staffcategories' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Staffcategorie', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/staffcategories/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_staffcategories' },
  ...
  showInList: ['row_count', 'work_title', 'category_name', 'wages', 'remark'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['work_title', 'category_name', 'wages', 'remark'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['work_title', 'category_name', 'wages', 'remark'] },
  ],
  ...
  fields: [
    ...
    { key: 'work_title', label: 'Work Title', type: 'text' },
    { key: 'category_name', label: 'Category Name', type: 'text', title: true, required: true },
    { key: 'wages', label: 'Wages', type: 'text' },
