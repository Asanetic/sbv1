...
const moduleApi = apiRoutes.expenses.base;

export const ExpensesSchema = {
  entity: 'expenses',              // DB table name; also drives default role names
                                     // (view_expenses / manage_expenses) and apiBase
  label: 'Expenses',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.expenses.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/expenses/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this expense?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_expenses' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Expense', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/expenses/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_expenses' },
  ...
  showInList: ['row_count', 'expense_name', 'expense_category', 'rate', 'site_name'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['expense_name', 'expense_category', 'rate', 'quantity', 'ref_no', 'expense_remark', 'site_id'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['expense_name', 'expense_category', 'rate', 'quantity', 'ref_no', 'expense_remark', 'site_id'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['expense_date', 'week_no', 'subcontracor', 'staff', 'admin'] },
  ],
  ...
  fields: [
    ...
    { key: 'expense_name', label: 'Expense Name', type: 'text', title: true, required: true },
    { key: 'expense_category', label: 'Expense Category', type: 'text' },
    { key: 'rate', label: 'Amount', type: 'text' , sum: true},
    { key: 'quantity', label: 'Quantity', type: 'text' },
    { key: 'ref_no', label: 'Ref No', type: 'text' },
    { key: 'expense_remark', label: 'Expense Remark', type: 'textarea', colSpan: 3 },
    ...resolveField('site_id', { as: 'site_name' }),
    { key: 'expense_date', label: 'Expense Date', type: 'datetime' },
    { key: 'week_no', label: 'Week No', type: 'money' },
    ...resolveField('subcontracor', { as: 'name' }),
    ...resolveField('staff', { as: 'name' }),
    ...resolveField('admin', { as: 'name' }),
