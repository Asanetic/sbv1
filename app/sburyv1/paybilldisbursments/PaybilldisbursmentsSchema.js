...
import { resolveField } from '../DataControl/sburyv1Schema';
// Use default base root (/)
const apiRoutes = getApiRoutes();
const moduleApi = apiRoutes.paybilldisbursments.base;

export const PaybilldisbursmentsSchema = {
  entity: 'paybill_disbursments',              // DB table name; also drives default role names
                                     // (view_paybilldisbursments / manage_paybilldisbursments) and apiBase
  label: 'Paybilldisbursments',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.paybilldisbursments.import,
  ...
  moduleRole: 'view_paybilldisbursments',
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/paybilldisbursments/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this paybilldisbursment?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_paybilldisbursments' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Paybilldisbursment', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/paybilldisbursments/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_paybilldisbursments' },
  ...
  showInList: ['row_count', 'trx_id', 'trx_date', 'trx_month_year', 'trx_remark', 'amount', 'trx_type', 'business_id'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['trx_id', 'trx_date', 'trx_month_year', 'trx_remark', 'amount', 'trx_type', 'business_id'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['trx_id', 'trx_date', 'trx_month_year', 'trx_remark', 'amount', 'trx_type', 'business_id'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['client_id', 'admin_id', 'TransactionType', 'BusinessShortCode', 'BillRefNumber', 'InvoiceNumber', 'OrgAccountBalance', 'ThirdPartyTransID', 'MSISDN', 'FirstName', 'MiddleName', 'LastName', 'trx_msg', 'account_id', 'used_status', 'filter_date', 'flw_id', 'flag_state', 'reconciled', 'trx_timestamp'] },
  ],
  ...
  fields: [
    ...
    { key: 'trxkey', label: 'Trxkey', type: 'text', system: true, editable: false },
    { key: 'trx_id', label: 'Trx Id', type: 'text' },
    { key: 'trx_date', label: 'Trx Date', type: 'datetime' },
    { key: 'trx_month_year', label: 'Trx Month Year', type: 'text' },
    { key: 'trx_remark', label: 'Trx Remark', type: 'textarea', colSpan: 3 },
    { key: 'amount', label: 'Amount', type: 'text' },
    { key: 'trx_type', label: 'Trx Type', type: 'text' },
    { key: 'business_id', label: 'Business Id', type: 'text' },
    { key: 'client_id', label: 'Client Id', type: 'text' },
    { key: 'admin_id', label: 'Admin Id', type: 'text' },
    { key: 'TransactionType', label: 'TransactionType', type: 'text' },
    { key: 'BusinessShortCode', label: 'BusinessShortCode', type: 'text' },
    { key: 'BillRefNumber', label: 'BillRefNumber', type: 'text' },
    { key: 'InvoiceNumber', label: 'InvoiceNumber', type: 'text' },
    { key: 'OrgAccountBalance', label: 'OrgAccountBalance', type: 'money' },
    { key: 'ThirdPartyTransID', label: 'ThirdPartyTransID', type: 'text' },
    { key: 'MSISDN', label: 'MSISDN', type: 'text' },
    { key: 'FirstName', label: 'FirstName', type: 'text' },
    { key: 'MiddleName', label: 'MiddleName', type: 'text' },
    { key: 'LastName', label: 'LastName', type: 'text' },
    { key: 'trx_msg', label: 'Trx Msg', type: 'text' },
    { key: 'account_id', label: 'Account Id', type: 'text' },
    { key: 'used_status', label: 'Used Status', type: 'text' },
    { key: 'filter_date', label: 'Filter Date', type: 'datetime' },
    { key: 'flw_id', label: 'Flw Id', type: 'text' },
    { key: 'flag_state', label: 'Flag State', type: 'text' },
    { key: 'reconciled', label: 'Reconciled', type: 'text' },
    { key: 'trx_timestamp', label: 'Trx Timestamp', type: 'datetime' },
