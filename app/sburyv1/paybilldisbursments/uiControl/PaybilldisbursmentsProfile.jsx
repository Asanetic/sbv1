...
// PaybilldisbursmentsProfile — pure shell. It resolves the id, wires up the
...
export default function PaybilldisbursmentsProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || PaybilldisbursmentsSchema;
  const id = idProp ?? searchParams.get(`${PaybilldisbursmentsSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, PaybilldisbursmentsActions, {
    id,
    onDone,
