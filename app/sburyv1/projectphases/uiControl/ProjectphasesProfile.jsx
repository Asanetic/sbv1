...
// ProjectphasesProfile — pure shell. It resolves the id, wires up the
...
export default function ProjectphasesProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || ProjectphasesSchema;
  const id = idProp ?? searchParams.get(`${ProjectphasesSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, ProjectphasesActions, {
    id,
    onDone,
