...
const moduleApi = apiRoutes.projectphases.base;

export const ProjectphasesSchema = {
  entity: 'project_phases',              // DB table name; also drives default role names
                                     // (view_projectphases / manage_projectphases) and apiBase
  label: 'Projectphases',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.projectphases.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/projectphases/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this projectphase?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_projectphases' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Projectphase', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/projectphases/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_projectphases' },
  ...
  showInList: ['row_count', 'phase_name', 'project_type', 'phase_remark', 'section'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['phase_name', 'project_type', 'phase_remark', 'section'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['phase_name', 'project_type', 'phase_remark', 'section'] },
  ],
  ...
  fields: [
    ...
    { key: 'phase_name', label: 'Phase Name', type: 'text', title: true, required: true },
    { key: 'project_type', label: 'Project Type', type: 'text' },
    { key: 'phase_remark', label: 'Phase Remark', type: 'textarea', colSpan: 3 },
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_projectphases', manage: 'manage_projectphases' },
};
