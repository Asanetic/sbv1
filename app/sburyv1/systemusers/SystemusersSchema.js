...
export const SystemusersSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/systemusers/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Systemuser', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/systemusers/profile', grid: true, form: false, rowAction: false },
  ...
  showInList: ['row_count', 'user_pic', 'name', 'email', 'tel', 'bundle_name', 'regdate', 'user_no'],
  ...
  sections: [
    ...
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['user_gender', 'last_seen', 'about', 'project_id', 'project_name', 'user_role'] },
  ],
  ...
  fields: [
    ...
    ...resolveField('ref_id', { as: 'bundle_name' }),
    { key: 'regdate', label: 'Regdate', type: 'datetime' },
    { key: 'user_no', label: 'User No', type: 'text' },
    { key: 'user_pic', label: 'Passport', type: 'image' , colSpan: 12, imageClass:'useravatar_120'},
