...
const moduleApi = apiRoutes.workschedule.base;

export const WorkscheduleSchema = {
  entity: 'work_schedule',              // DB table name; also drives default role names
                                     // (view_workschedule / manage_workschedule) and apiBase
  label: 'Workschedule',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.workschedule.import,
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/workschedule/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this workschedule?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_workschedule' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Workschedule', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/workschedule/profile', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_workschedule' },
  ...
  showInList: ['row_count', 'site_name', 'task_description', 'subtotal', 'date_', 'client', 'week_no'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['site_id', 'task_description', 'subtotal', 'date_', 'client', 'week_no'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['site_id', 'task_description', 'subtotal', 'date_', 'client', 'week_no'] },
  ],
  ...
  fields: [
    ...
    { key: 'date_', label: 'Date ', type: 'datetime' },
...
// dyn-btn-accent-teal   { border-color: transparent; color: #0f766e; }
  ...
  // roles: { view: 'view_workschedule', manage: 'manage_workschedule' },
};
