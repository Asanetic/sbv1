...
const moduleApi = apiRoutes.paymentconfirmations.base;

export const PaymentconfirmationsSchema = {
  entity: 'payment_confirmations',              // DB table name; also drives default role names
                                     // (view_paymentconfirmations / manage_paymentconfirmations) and apiBase
  label: 'Paymentconfirmations',                 // optional, defaults to entity capitalized
  apiBase: moduleApi,

  //api endpint for importing data from csv
  importDataEndpoint : apiRoutes.paymentconfirmations.import,
  ...
  moduleRole: 'view_paymentconfirmations',
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/paymentconfirmations/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this paymentconfirmation?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_paymentconfirmations' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Paymentconfirmation', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/paymentconfirmations/profile', grid: false, form: false, rowAction: false },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_paymentconfirmations' },
  ...
  showInList: ['row_count', 'transaction_date_time', 'transaction_amount', 'transaction_receipt', 'receiver_public_name'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['result_type', 'result_code', 'result_desc', 'originator_conversation_id', 'conversation_id', 'transaction_id', 'transaction_amount'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['result_type', 'result_code', 'result_desc', 'originator_conversation_id', 'conversation_id', 'transaction_id', 'transaction_amount'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['transaction_receipt', 'recipient_registered', 'charges_paid_funds', 'receiver_public_name', 'transaction_date_time', 'utility_funds', 'working_funds', 'queue_timeout_url'] },
  ],
  ...
  fields: [
    ...
    { key: 'result_type', label: 'Result Type', type: 'text' },
    { key: 'result_code', label: 'Result Code', type: 'text', title: true },
    { key: 'result_desc', label: 'Result Desc', type: 'text' },
    { key: 'originator_conversation_id', label: 'Originator Conversation Id', type: 'text' },
    { key: 'conversation_id', label: 'Conversation Id', type: 'text' },
    { key: 'transaction_id', label: 'Transaction Id', type: 'text' },
    { key: 'transaction_amount', label: 'Transaction Amount', type: 'money' , sum: true},
    { key: 'transaction_receipt', label: 'Transaction Receipt', type: 'textarea' },
    { key: 'recipient_registered', label: 'Recipient Registered', type: 'text' },
    { key: 'charges_paid_funds', label: 'Charges Paid Funds', type: 'text' },
    { key: 'receiver_public_name', label: 'Receiver Name', type: 'text', title: true },
    { key: 'transaction_date_time', label: 'Transaction Date Time', type: 'datetime' },
    { key: 'utility_funds', label: 'Utility Funds', type: 'text' },
    { key: 'working_funds', label: 'Working Funds', type: 'text' },
    { key: 'queue_timeout_url', label: 'Queue Timeout Url', type: 'text' },
