...
// PaymentconfirmationsProfile — pure shell. It resolves the id, wires up the
...
export default function PaymentconfirmationsProfile({ id: idProp, onDone, hiddenActions = [], presetValues, schemaOverride }) {
  const searchParams = useSearchParams();
  const schema = schemaOverride || PaymentconfirmationsSchema;
  const id = idProp ?? searchParams.get(`${PaymentconfirmationsSchema.entity}_dataNode`);
  const form = useEntityFormController(schema, PaymentconfirmationsActions, {
    id,
    onDone,
