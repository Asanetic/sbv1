...
export const StaffSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/sburyv1/staff/list', grid: false, form: true },
    ...
    { key: 'new', label: 'New Staff', icon: 'plus', variant: 'outline-primary', navigateTo: '/sburyv1/staff/profile', grid: true, form: false, rowAction: false },
  ...
  showInList: ['row_count', 'name', 'mobile', 'national_id', 'daily_wages', 'work_title', 'site_name', 'allocated_site_name'],

  //export columns these columns are used to generate upload csv template file
  exportColumns: ['name', 'mobile', 'national_id', 'daily_wages', 'staff_role', 'site_id', 'allocated_site_name'],

  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['name', 'mobile', 'national_id', 'daily_wages', 'staff_role', 'site_id', 'allocated_site_name'] },
    { key: 'other_details', label: 'Other Details', columns: 3, fields: ['notification_number'] },
  ],
  ...
  fields: [
    ...
    { key: 'daily_wages', label: 'Daily Wages', type: 'money' },
    ...resolveField('staff_role', { as: 'work_title' }),
    ...resolveField('site_id', { as: 'site_name' }),
    { key: 'allocated_site_name', label: 'Allocated Site Name', type: 'text', title: true, required: true },
    { key: 'notification_number', label: 'Notification Number', type: 'text' },
